      ...
      while (png_ptr->zstream.avail_in)
      {
         ...
         if (ret != 0 && ret != 1)
         {
            ...
            if (text ==  0)
            {
               ...
               __memcpy(text, chunkdata, prefix_size);
            }
...
#line 210
            ...
            __memcpy(text + prefix_size, msg, text_size + 1);
            break;
         }
...
__memcpy(text + prefix_size, png_ptr->zbuf, text_size - prefix_size);
               __memcpy(text, chunkdata, prefix_size);
               *(text + text_size) = 0x00;
            }
            else
...
#line 331
   if (width == 0 || width > ((png_uint_32)0x7fffffffL) || height == 0 ||
        height > ((png_uint_32)0x7fffffffL))
...
#line 519
   if (png_ptr->color_type == (2 | 1))
   {
      if (info_ptr != 0 && (info_ptr->valid & 0x0010))
      {
...
png_handle_gAMA(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0001)
...
png_handle_sBIT(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0002))
   {
...
png_handle_cHRM(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0004)
...
#line 815
   if (info_ptr->valid & 0x0800)
      {
      if (__abs(int_x_white - 31270L) > 1000 ||
          __abs(int_y_white - 32900L) > 1000 ||
          __abs(int_x_red - 64000L) > 1000 ||
          __abs(int_y_red - 33000L) > 1000 ||
          __abs(int_x_green - 30000L) > 1000 ||
          __abs(int_y_green - 60000L) > 1000 ||
          __abs(int_x_blue - 15000L) > 1000 ||
          __abs(int_y_blue - 6000L) > 1000)
         {
...
png_handle_sRGB(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0800))
   {
...
#line 950
   if (info_ptr->valid & 0x0004)
      if (__abs(info_ptr->int_x_white - 31270L) > 1000 ||
          __abs(info_ptr->int_y_white - 32900L) > 1000 ||
          __abs(info_ptr->int_x_red - 64000L) > 1000 ||
          __abs(info_ptr->int_y_red - 33000L) > 1000 ||
          __abs(info_ptr->int_x_green - 30000L) > 1000 ||
          __abs(info_ptr->int_y_green - 60000L) > 1000 ||
          __abs(info_ptr->int_x_blue - 15000L) > 1000 ||
          __abs(info_ptr->int_y_blue - 6000L) > 1000)
         {
            png_warning(png_ptr,
              "Ignoring incorrect cHRM value when sRGB is also present");
         }
...

{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x1000))
   {
...
png_handle_tRNS(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0010))
   {
...
png_handle_bKGD(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0020))
   {
...
png_handle_hIST(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0040))
   {
...
png_handle_pHYs(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0080))
   {
...
png_handle_oFFs(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0100))
   {
...
png_handle_pCAL(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0400))
   {
...
#line 1645
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x4000))
   {
...
png_handle_tIME(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   else if (info_ptr != 0 && (info_ptr->valid & 0x0200))
   {
...
#line 1841
   text_ptr->text = text;
   text_ptr->text_length = __strlen(text);
...
png_handle_unknown(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   {
#line 2038
      if (__memcmp(png_ptr->chunk_name, png_IDAT, 4))   
         png_ptr->mode |= 0x08;
   }
...
{
   ;
   if (((chunk_name[0]) < 41 || (chunk_name[0]) > 122 || ((chunk_name[0]) > 90 && (chunk_name[0]) < 97)) || ((chunk_name[1]) < 41 || (chunk_name[1]) > 122 || ((chunk_name[1]) > 90 && (chunk_name[1]) < 97)) ||
       ((chunk_name[2]) < 41 || (chunk_name[2]) > 122 || ((chunk_name[2]) > 90 && (chunk_name[2]) < 97)) || ((chunk_name[3]) < 41 || (chunk_name[3]) > 122 || ((chunk_name[3]) > 90 && (chunk_name[3]) < 97)))
   {
   ...
   (png_structp png_ptr, png_bytep row, int mask)
{
   ...
   {
#line 2146
__memcpy(row, png_ptr->row_buf + 1, (png_size_t)((png_ptr->width * png_ptr->row_info.pixel_depth + 7) >> 3));
   }
   else
   {
...
#line 2487
         ...
         default:
         {
            ...
            for (i = 0; i < row_info->width; i++)
            {
               ...
               __memcpy(v, sp, pixel_bytes);
               for (j = 0; j < jstop; j++)
               {
                  __memcpy(dp, v, pixel_bytes);
                  dp -= pixel_bytes;
               }
               sp -= pixel_bytes;
            }
...
#line 2934
        (png_ptr->transformations & (0x8000L)) ||
