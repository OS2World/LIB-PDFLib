...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0020)
      && background != 0)
   {
      ;
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0004))
   {
      ;
      if (white_x != 0)
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0001)
      && file_gamma != 0)
   {
      ;
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0800)
      && file_srgb_intent != 0)
   {
      ;
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x1000)
      && name != 0 && profile != 0 && proflen != 0)
   {
      ;
...
{
   if (png_ptr != 0 && info_ptr != 0 && spalettes != 0)
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0040)
      && hist != 0)
   {
      ;
      *hist = info_ptr->hist;
...
{
   if (png_ptr != 0 && info_ptr != 0 && width != 0 && height != 0 &&
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0100)
      && offset_x != 0 && offset_y != 0 && unit_type != 0)
   {
      ;
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0400)
      && purpose != 0 && X0 != 0 && X1 != 0 && type != 0 &&
      nparams != 0 && units != 0 && params != 0)
   {
      ;
...
png_get_PLTE(png_structp png_ptr, png_infop info_ptr, png_colorp *palette,
   int *num_palette)
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0008)
       && palette != 0)
   {
      ;
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0002)
      && sig_bit != 0)
   {
      ;
...
png_get_text(png_structp png_ptr, png_infop info_ptr, png_textp *text_ptr,
   int *num_text)
{
   if (png_ptr != 0 && info_ptr != 0 && info_ptr->num_text > 0)
   {
#line 728
;
      if (text_ptr != 0)
...
{
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0200)
       && mod_time != 0)
   {
      ;
...
{
   png_uint_32 retval = 0;
   if (png_ptr != 0 && info_ptr != 0 && (info_ptr->valid & 0x0010))
   {
      ;
