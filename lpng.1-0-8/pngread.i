...
#line 115
   ...
   switch (inflateInit_((&png_ptr->zstream), "1.1.3", sizeof(z_stream)))
   {
     case 0:   break;
     case (-4):
...
#line 325
      ...
      else if (png_handle_as_unknown(png_ptr, png_ptr->chunk_name))
      {
         ...
         if (!__memcmp(png_ptr->chunk_name, png_PLTE, 4))
            png_ptr->mode |= 0x02;
         else if (!__memcmp(png_ptr->chunk_name, png_IDAT, 4))
         {
