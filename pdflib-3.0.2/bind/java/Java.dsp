...
# ADD CPP /nologo /Gz /MT /W3 /O2 /I "c:\jdk1.2.2\include" /I "c:\jdk1.2.2\include\win32" /I "..\..\pdflib" /D "WIN32" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "_MT" /D "PDFLIB_STATIC" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib zlib.lib libpng.lib libtiff.lib pdflib.lib /nologo /base:"0x55320000" /dll /pdb:none /machine:I386 /out:"pdf_java.dll" /libpath:"..\..\pdflib" /libpath:"..\..\..\zlib" /libpath:"..\..\..\libpng" /libpath:"..\..\..\libtiff"
# SUBTRACT LINK32 /map /debug
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Desc=Creating jar file and documentation...
PostBuild_Cmds=c:\jdk1.2.2\bin\javac pdflib.java	rmdir /s /q com	mkdir com\pdflib	copy pdflib.class com\pdflib	c:\jdk1.2.2\bin\jar cvf pdflib.jar com/pdflib/pdflib.class	rmdir /s /q javadoc	mkdir javadoc	c:\jdk1.2.2\bin\javadoc -notree -author -version -d javadoc -public pdflib.java
